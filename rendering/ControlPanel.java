    ...
    public ControlPanel(NoteIndices notes, ArrayPanel panel) {
        ...
        playButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Integer[] temp = Arrays.copyOf(notes.getNotes(), notes.size());
                    ...
                    public void run() {
                        if (index < events.size()) {
                            ...
                            for(int i = 0; i < affected.size(); i++) {
                            	int temp = affected.get(i);
                            	scale.playNote(temp, e.isEmphasized());
                            	// 3. Highlight those affected indices.
                            	notes.highlightNote(temp);
                            }
                            panel.repaint();
                        } else {
                            this.cancel();
