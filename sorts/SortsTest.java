...
public class SortsTest {
	...
	/**
	 * Creates arrays for testing on different sorts
	 * Performs a total of 8 checks per sort
	 * @param sort a String representing the name of a sort
	 */
	public static void applyTest(String sort) {
		...
		/* finds the correct sort and performs the sorting on each test array */
		switch (sort) {
        case "Selection":
